...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center pt-20 pb-10 px-6 md:px-10 relative overflow-hidden"
    >
      {/* Background gradient */}
      ...
      <div
        className="absolute -z-10 bottom-1/4 left-1/4 w-96 h-96 bg-purple-200/20 dark:bg-purple-500/5 rounded-full blur-3xl animate-pulse-slow"
      ...
      <div className="max-w-7xl w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <p className="text-primary/80 dark:text-white/80 mb-3 font-medium">
                Hello, I'm
              </p>
              ...
              >
                Dedicated Sales and Accounting Officer with over 1.5 years of
                experience managing financial records, handling transactions,
                and driving sales growth. Currently pursuing a BBA-BI at Apex
                College while interning at Prabhu Bank.
              </motion.p>
              ...
              >
                <Button className="group relative overflow-hidden px-6 py-3 shadow-md">
                  <span className="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 bg-primary dark:bg-purple-600 group-hover:skew-x-12 group-hover:translate-x-full"></span>
                  <span className="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform  bg-purple-600 dark:bg-purple-900 translate-x-full group-hover:skew-x-0 group-hover:translate-x-0"></span>
                ...
                <Button
                  variant="outline"
                  className="px-6 py-3 shadow-sm transition-all duration-300 hover:border-primary dark:hover:border-white"
                >
              ...
              <div className="animated-border rounded-full w-full h-full overflow-hidden">
                <div className="w-full h-full rounded-full overflow-hidden border-4 border-white dark:border-gray-800">
                  <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 rounded-full flex items-center justify-center">
                    <span className="text-6xl font-playfair font-bold text-primary dark:text-white">
                      SS
                    </span>
                  </div>
                </div>
      ...
      >
        <a
          href="#about"
          className="text-primary/60 dark:text-white/60 hover:text-primary dark:hover:text-white transition-colors duration-300"
        >
